...
!function(t, e) {
    ...
    class $ extends B {
        ...
        _removeElement(t) {
            ...
            const e = a(t);
            R.one(t, "transitionend", ()=>this._destroyElement(t)),
            h(t, e)
        }
        _destroyElement(t) {
            t.parentNode && t.parentNode.removeChild(t),
    ...
    R.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', $.handleDismiss(new $)),
    v("alert", $);
    class z extends B {
        static get DATA_KEY() {
            return "bs.button"
    ...
    class Z extends B {
        ...
        pause(t) {
            t || (this._isPaused = !0),
            W.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (l(this._element),
            this.cycle(!0)),
        ...
        _handleSwipe() {
            ...
            this.touchDeltaX = 0,
            e && this._slide(e > 0 ? G : X)
        }
        _addEventListeners() {
            this._config.keyboard && R.on(this._element, "keydown.bs.carousel", t=>this._keydown(t)),
            "hover" === this._config.pause && (R.on(this._element, "mouseenter.bs.carousel", t=>this.pause(t)),
        ...
        _addTouchEventListeners() {
            ...
            this._pointerEvent ? (R.on(this._element, "pointerdown.bs.carousel", e=>t(e)),
            R.on(this._element, "pointerup.bs.carousel", t=>s(t)),
            this._element.classList.add("pointer-event")) : (R.on(this._element, "touchstart.bs.carousel", e=>t(e)),
        ...
        _keydown(t) {
            ...
            this._slide(G)) : "ArrowRight" === t.key && (t.preventDefault(),
            this._slide(X)))
        }
        _getItemIndex(t) {
            return this._items = t && t.parentNode ? W.find(".carousel-item", t.parentNode) : [],
    ...
    class et extends B {
        ...
        show() {
            if (this._isTransitioning || this._element.classList.contains("show"))
                return;
            let t, e;
            this._parent && (t = W.find(".show, .collapsing", this._parent).filter(t=>"string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains("collapse")),
            0 === t.length && (t = null));
            const s = W.findOne(this._selector);
            if (t) {
                const i = t.find(t=>s !== t);
                if (e = i ? E.get(i, "bs.collapse") : null,
    ...
    class dt extends B {
        ...
        _completeHide(t) {
            R.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach(t=>R.off(t, "mouseover", p)),
            this._popper && this._popper.destroy(),
        ...
        static dropdownInterface(t, e) {
            ...
            if (s || (s = new dt(t,"object" == typeof e ? e : null)),
            "string" == typeof e) {
                if (void 0 === s[e])
                    throw new TypeError(`No method named "${e}"`);
                s[e]()
            ...
            for (let s = 0, i = e.length; s < i; s++) {
                ...
                if (t) {
                    ...
                    if (e.includes(i._element) || "inside" === i._config.autoClose && !s || "outside" === i._config.autoClose && s)
                        continue;
                    if ("keyup" === t.type && "Tab" === t.key && i._menu.contains(t.target))
                        continue;
    ...
    const ut = ()=>{
      ...
      , gt = (t=ut())=>{
        ...
        pt(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", "paddingRight", e=>e + t),
      ...
      , _t = (t,e)=>{
        W.find(t).forEach(t=>{
            ...
            void 0 === s ? t.style.removeProperty(e) : (F.removeDataAttribute(t, e),
            t.style[e] = s)
        }
        )
    }
    ...
    class yt {
        ...
        dispose() {
            this._isAppended && (R.off(this._element, "mousedown.bs.backdrop"),
    ...
    class Tt extends B {
        ...
        _showElement(t) {
            ...
            if (e) {
                ...
                R.one(this._dialog, "transitionend", i),
                h(this._dialog, t)
            } else
                i()
        }
        ...
        _triggerBackdropTransition() {
            ...
            R.one(this._element, "transitionend", ()=>{
                ...
                t || (R.one(this._element, "transitionend", ()=>{
        ...
        _adjustDialog() {
            const t = this._element.scrollHeight > document.documentElement.clientHeight
              , e = ut()
              , s = e > 0;
            (!s && t && !b() || s && !t && b()) && (this._element.style.paddingLeft = e + "px"),
            (s && !t && !b() || !s && t && b()) && (this._element.style.paddingRight = e + "px")
        }
        _resetAdjustments() {
    ...
    const Ct = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      ...
      , Nt = (t,e)=>{
        ...
        if (e.includes(s))
            return !Ct.has(s) || Boolean(Dt.test(t.nodeValue) || St.test(t.nodeValue));
    ...
    class Rt extends B {
        ...
        show() {
            ...
            if (this.tip.classList.contains("fade")) {
                const t = a(this.tip);
                R.one(this.tip, "transitionend", g),
                h(this.tip, t)
            } else
                g()
        }
        ...
        setElementContent(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = Ot(e, this.config.allowList, this.config.sanitizeFn)),
        ...
        _initializeOnDelegatedTarget(t, e) {
            ...
            return (e = e || E.get(t.delegateTarget, s)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach(t=>{
                if ("click" === t)
                    R.on(this._element, this.constructor.Event.CLICK, this.config.selector, t=>this.toggle(t));
                else if ("manual" !== t) {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new Rt(this,s)),
                "string" == typeof t)) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class Kt extends Rt {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new Kt(this,s),
                E.set(this, "bs.popover", e)),
                "string" == typeof t)) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class Yt extends B {
        ...
        _activate(t) {
            ...
            const e = this._selector.split(",").map(e=>`${e}[data-bs-target="${t}"],${e}[href="${t}"]`)
              , s = W.findOne(e.join(","));
            s.classList.contains("dropdown-item") ? (W.findOne(".dropdown-toggle", s.closest(".dropdown")).classList.add("active"),
    ...
    class Vt extends B {
        ...
        _transitionComplete(t, e, s) {
            ...
            i && i.classList.contains("dropdown-menu")) {
                ...
                e && W.find(".dropdown-toggle", e).forEach(t=>t.classList.add("active")),
                t.setAttribute("aria-expanded", !0)
            }
            s && s()
        }
    ...
    class Xt extends B {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if (e || (e = new Xt(this,"object" == typeof t && t)),
                "string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t](this)
